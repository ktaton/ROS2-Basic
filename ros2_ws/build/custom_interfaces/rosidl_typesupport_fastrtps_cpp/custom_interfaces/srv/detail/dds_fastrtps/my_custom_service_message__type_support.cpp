...
#include "custom_interfaces/srv/detail/my_custom_service_message__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const custom_interfaces::srv::MyCustomServiceMessage_Request & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  custom_interfaces::srv::MyCustomServiceMessage_Request & ros_message)
{
  // Member: move
  cdr >> ros_message.move;
...
{
  auto typed_message =
    static_cast<const custom_interfaces::srv::MyCustomServiceMessage_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<custom_interfaces::srv::MyCustomServiceMessage_Request *>(
    untyped_ros_message);
...
{
  return &custom_interfaces::srv::typesupport_fastrtps_cpp::_MyCustomServiceMessage_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, custom_interfaces, srv, MyCustomServiceMessage_Request)() {
  return &custom_interfaces::srv::typesupport_fastrtps_cpp::_MyCustomServiceMessage_Request__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_custom_interfaces
cdr_serialize(
  const custom_interfaces::srv::MyCustomServiceMessage_Response & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: success
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  custom_interfaces::srv::MyCustomServiceMessage_Response & ros_message)
{
  // Member: success
  {
    uint8_t tmp;
...
{
  auto typed_message =
    static_cast<const custom_interfaces::srv::MyCustomServiceMessage_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<custom_interfaces::srv::MyCustomServiceMessage_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &custom_interfaces::srv::typesupport_fastrtps_cpp::_MyCustomServiceMessage_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, custom_interfaces, srv, MyCustomServiceMessage_Response)() {
  return &custom_interfaces::srv::typesupport_fastrtps_cpp::_MyCustomServiceMessage_Response__handle;
}
...
{
  return &custom_interfaces::srv::typesupport_fastrtps_cpp::_MyCustomServiceMessage__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, custom_interfaces, srv, MyCustomServiceMessage)() {
  return &custom_interfaces::srv::typesupport_fastrtps_cpp::_MyCustomServiceMessage__handle;
}
