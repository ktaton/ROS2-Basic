...
#include "custom_interfaces/srv/detail/my_custom_service_message__rosidl_typesupport_fastrtps_c.h"
...
using _MyCustomServiceMessage_Request__ros_msg_type = custom_interfaces__srv__MyCustomServiceMessage_Request;
...
size_t get_serialized_size_custom_interfaces__srv__MyCustomServiceMessage_Request(
  const void * untyped_ros_message,
...
static uint32_t _MyCustomServiceMessage_Request__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_custom_interfaces__srv__MyCustomServiceMessage_Request(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_custom_interfaces
size_t max_serialized_size_custom_interfaces__srv__MyCustomServiceMessage_Request(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
static size_t _MyCustomServiceMessage_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_custom_interfaces__srv__MyCustomServiceMessage_Request(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, custom_interfaces, srv, MyCustomServiceMessage_Request)() {
...
using _MyCustomServiceMessage_Response__ros_msg_type = custom_interfaces__srv__MyCustomServiceMessage_Response;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_custom_interfaces
size_t get_serialized_size_custom_interfaces__srv__MyCustomServiceMessage_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _MyCustomServiceMessage_Response__ros_msg_type * ros_message = static_cast<const _MyCustomServiceMessage_Response__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_custom_interfaces__srv__MyCustomServiceMessage_Response(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_custom_interfaces
size_t max_serialized_size_custom_interfaces__srv__MyCustomServiceMessage_Response(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
static size_t _MyCustomServiceMessage_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_custom_interfaces__srv__MyCustomServiceMessage_Response(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, custom_interfaces, srv, MyCustomServiceMessage_Response)() {
...
// already included above
// #include "custom_interfaces/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
#include "custom_interfaces/srv/my_custom_service_message.h"
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, custom_interfaces, srv, MyCustomServiceMessage)() {
