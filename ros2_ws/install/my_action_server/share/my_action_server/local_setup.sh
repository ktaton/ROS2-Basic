...
: ${AMENT_CURRENT_PREFIX:="/home/user/ros2_ws/install/my_action_server"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/my_action_server/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/my_action_server/environment/path.sh"
