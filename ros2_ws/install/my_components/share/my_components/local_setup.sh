...
: ${AMENT_CURRENT_PREFIX:="/home/user/ros2_ws/install/my_components"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/my_components/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/my_components/environment/path.sh"
